  ...
  return (
    <>
      ...
      <div className="titulo-page">
        <text className="titulo">Itens Aprovados</text>
      </div>
      ...
      <nav className="page">
        ...
        <div className="corpoEsquerdaValida">
          <div className="infoDoacoesFundoIA">
        ...
        <div className="corpoDireitaValida">
          <div className="infoSolicitacoesFundoIA">
...
export default AdminItensAprovados;